        ...
        <nav className="flex justify-between items-center px-10 py-5 bg-[#2596be] text-white">
            ...
            <div>
                <ul className="flex gap-10 font-semibold">
                    ...
                    <li className="hover:text-gray-400 hover:underline hover:underline-offset-1 hover:transition-all hover:duration-1000"><Link to='/testcalculator'>TestPriceCalculator</Link></li>
                </ul>
            </div>
        </nav>
        </>
